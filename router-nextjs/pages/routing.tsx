...
export default function RoutingPage() {
  ...
  return (
    <ConsoleLayout title='Routing Groups / Deployments' description='配置分组策略，按 provider + model 设定权重和优先级，实现稳定路由。'>
      <section className='grid-2'>
        ...
        <section className='panel stack'>
          ...
          <button onClick={async () => {
            await api(`/api/routing/groups/${dep.group}/deployments`, {
              method: 'POST',
              body: JSON.stringify({
